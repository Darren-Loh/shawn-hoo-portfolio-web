...
function BlogPage() {
  ...
  let blogPosts = blogRecords && blogRecords.map((post,index) => <BlogPost key={index} instanceID = {index} recordHeader = {post.header} bodyPara = {post.bodyPara} recordDate = {post.date} recordTags = {post.tags} />)
